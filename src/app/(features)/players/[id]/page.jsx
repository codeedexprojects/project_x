...
export default function PlayerProfilePage() {
  ...
  const { singleUser, loading, error, updateLoading } = useSelector((state) => state.playerSlice);
  ...
  useEffect(() => {
    if (singleUser?.user) {
      ...
      setImagePreview(user.image || "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop");
    }
  }, [singleUser]);
  ...
  const transformPlayerData = () => {
    ...
    return {
      ...
      profileImage: user.image || "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop"
    };
  };
  ...
  const handleCancel = () => {
    ...
    setImageFile(null);
    setImagePreview(singleUser?.user?.image || "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop");
    setIsEditing(false);
  };
