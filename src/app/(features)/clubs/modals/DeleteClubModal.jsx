...
import { deleteClubs } from "@/redux/slice/clubSlice";

const DeleteClubModal = ({ isOpen, onClose, onConfirm, club, isDeleting }) => {
      ...
      <div className="bg-zinc-900 border border-zinc-700 text-white rounded-2xl shadow-xl w-full max-w-md p-6 animate-fadeIn">
        ...
        <div className="mt-5 text-center">
          ...
          <h3 className="text-lg font-semibold mb-2">
            Delete <span className="text-red-400">{club?.name}</span>?
          </h3>
